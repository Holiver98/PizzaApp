...
public interface IRatingDao {
    /**
     * Saves the rating into com.github.holiver98.database.
    ...
    /**
     * Gets all the ratings from the com.github.holiver98.database, of a given pizza.
     *
    ...
    /**
     * Updates the ratings in the com.github.holiver98.database, that ahs the same id, as the rating argument.
     *
    ...
    /**
     * Deletes the rating from the com.github.holiver98.database, if it exists.
